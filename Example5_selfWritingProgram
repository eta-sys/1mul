...
Program finds "My old row" and replaced it to "My new row". Keep in mind that new length has to be less or equal to old one, else row pointers set at program start will be corupted.
