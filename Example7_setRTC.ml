If you need a RTC you have to set it every time when power-up. Use next program:
...
Naturally you have to replace "myNET" with your's WiFi name and "myPW" with your PW.
